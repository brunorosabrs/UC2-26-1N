...
// Na linha 13, o nome correto da variável deve ser: nameType (camelCase) e também,
// na linha 13, a variável typeof: name, deve iniciar em minuscula;
//let name = "Maria";
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// Na linha 32, o nome da variável correta em camelCase é: secondNumber
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// Na linha 52, a variável de conversão correta é: value.toString();
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// Linha 70 , a variavel number deve ser com inicial Maiuscula;
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// Linha 89 TypeOf está incorreto, o correto é : typeof em minuscula,
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// O erro foi nao ter colocado os ()
...
// 1. Corrija o código
// 2. Explique qual foi o erro
// O erro foi não ter colocado  () no final toString()
