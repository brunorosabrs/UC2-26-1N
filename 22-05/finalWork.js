...
function createCharacter() {
    ...
    console.log(`
====================================
    ${playerName.toUpperCase()} CHOOSE YOUR CLASS
====================================
...
function guardianAttack() {
    ...
    console.log("🛡️ The Guardian crushes the enemy with a heavy hammer!")
...
function berserkerAttack() {
    ...
    console.log("🔥 The Berserker unleashes a furious attack!")
