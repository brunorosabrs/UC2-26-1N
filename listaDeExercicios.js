...
const typeIsStudent = typeof isStudent
...
const backToString = String(convertedNumber)
...
//
const result4 = ((10 + 2) * (3 + 1)) / (2 + 2) + (5 * (2 + 3))
...
const canEnterParty = isAdult || hasLicense
